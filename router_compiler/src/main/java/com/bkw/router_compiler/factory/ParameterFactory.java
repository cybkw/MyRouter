package com.bkw.router_compiler.factory;
...
public class ParameterFactory {
    ...
    private ParameterFactory(Builder builder) {
        ...
        methodBuidler = MethodSpec.methodBuilder(Cons.METHOD_PARAMETER_NAME)
    ...
    public void buildStatement(Element element) {
        ...
        if (type == TypeKind.INT.ordinal()) {
            ...
            if (typeMirror.toString().equalsIgnoreCase(Cons.STRING)) {
